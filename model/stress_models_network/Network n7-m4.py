"""
Model file created on 2021-08-20 14:00:09.209244 
...
variables = ['ABC', 'DEFG', 'CDEF', 'CDF', 'ABDG', 'ADF', 'BC', 'BCDE', 'ADEF', 'F', 'AFG', 'BCG', 'ACEF', 'ABCE', 'ABD', 'BE', 'ABCD', 'Kd', 'ACEG', 'ADFG', 'AE', 'ABCG', 'CG', 'CDEG', 'ACE', 'CDG', 'CDFG', 'ACDG', 'BDEF', 'BCFG', 'CF', 'ABEF', 'BDFG', 'CE', 'BDE', 'ACD', 'BEFG', 'BG', 'ACFG', 'AEFG', 'BDEG', 'DG', 'CEFG', 'BDG', 'FG', 'AD', 'BF', 'B', 'BEF', 'AB', 'AC', 'ADE', 'ABDE', 'ABCF', 'ABF', 'ABEG', 'BCEG', 'G', 'CD', 'AG', 'ACDE', 'BEG', 'BCF', 'ABFG', 'DEG', 'DFG', 'ACDF', 'BDF', 'BCE', 'EG', 'BFG', 'EFG', 'ABE', 'ADEG', 'CFG', 'BCEF', 'EF', 'ACF', 'BCD', 'AEG', 'AF', 'BCDG', 'ABG', 'CEG', 'BCDF', 'A', 'ACG', 'ADG', 'DEF', 'DE', 'E', 'ABDF', 'CDE', 'AEF', 'D', 'CEF', 'DF', 'C', 'BD', 'C_tot', 'G_tot', 'A_tot', 'B_tot', 'E_tot', 'D_tot', 'F_tot']
...
labeled_components = ['ABC', 'ABDG', 'ADF', 'ADEF', 'AFG', 'ACEF', 'ABCE', 'ABD', 'ABCD', 'ACEG', 'ADFG', 'AE', 'ABCG', 'ACE', 'ACDG', 'ABEF', 'ACD', 'ACFG', 'AEFG', 'AD', 'AB', 'AC', 'ADE', 'ABDE', 'ABCF', 'ABF', 'ABEG', 'AG', 'ACDE', 'ABFG', 'ACDF', 'ABE', 'ADEG', 'ACF', 'AEG', 'AF', 'ABG', 'A', 'ACG', 'ADG', 'ABDF', 'AEF'] 
...
def data_function(state):
    ...
    return A*data_min/A_tot + data_max*(AB + ABC + ABCD + ABCE + ABCF + ABCG + ABD + ABDE + ABDF + ABDG + ABE + ABEF + ABEG + ABF + ABFG + ABG + AC + ACD + ACDE + ACDF + ACDG + ACE + ACEF + ACEG + ACF + ACFG + ACG + AD + ADE + ADEF + ADEG + ADF + ADFG + ADG + AE + AEF + AEFG + AEG + AF + AFG + AG)/A_tot
